...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-graph-up"></i> Sales Transactions
            <small>Detailed sales report</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="report-page">
        <div class="box box-primary box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-receipt-cutoff"></i> Sales Transactions Report
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-sales-transactions') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report shows all sales transactions grouped by day within the selected date range. It includes totals, discounts, payments, and balances. Click "Print" to generate the detailed report.</p>
                </div>
            </div>
        </div>
    </div>
