...
<div class="report-container">
    ...
    @if(isset($invoices) && $invoices->count() > 0)
        ...
        <div class="stats-row">
            ...
            <div class="stat-box">
                <div class="number">{{ number_format(($invoices->sum('total_before_discount') ?? $invoices->sum('total')) - $invoices->sum('total'), 2) }}</div>
        ...
        <table class="report-table">
            ...
            <tr>
                ...
                <th style="width: 110px; text-align: right;">NET</th>
