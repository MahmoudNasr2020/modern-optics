...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Outstanding invoices report</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="report-page">
        <div class="box box-danger box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-clock-history"></i> Outstanding Invoices
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="row info-cards">
                    ...
                    <div class="col-md-{{ auth()->user()->canSeeAllBranches() ? '3' : '4' }}">
                        <div class="info-card">
                            ...
                            <h3>Select Cut-off Date</h3>
                            <p>Choose report date</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-{{ auth()->user()->canSeeAllBranches() ? '3' : '4' }}">
                        <div class="info-card">
                            ...
                            <p>Not delivered/returned/canceled</p>
                        </div>
                    </div>
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-pending-invoices') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-5">
                            ...
                            <div class="col-md-{{ auth()->user()->canSeeAllBranches() ? '5' : '10' }}">
                                <div class="form-group">
                                    <label>
                                        <i class="bi bi-calendar-event"></i> Date To (Cut-off Date)
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report shows all pending invoices (not delivered, returned, or canceled) up to the selected date. It includes details of total amounts, discounts, payments, and remaining balances.</p>
                </div>
            </div>
        </div>
    </div>
