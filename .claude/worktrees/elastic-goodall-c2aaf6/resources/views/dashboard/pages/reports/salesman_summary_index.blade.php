...
@section('title', 'Sales Summary Per Salesman')
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-person-lines-fill"></i> Sales Summary Per Salesman
            <small>Total sales overview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Reports</a></li>
            <li class="active">Sales Summary Per Salesman</li>
        </ol>
    </section>
    ...
    <div class="report-page">
        <div class="box box-danger box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-person-lines-fill"></i> Salesman Totals Report
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.reports.salesman.summary.print') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report provides a summary of total sales per salesman, showing sales before discount, after discount, and the percentage contribution of each salesman to the overall sales for the selected period.</p>
                </div>
            </div>
        </div>
    </div>
