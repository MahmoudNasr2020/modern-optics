...
@section('content')
    ...
    <style>
        ...
        .box-lens-details .box-header .box-title {
            font-size: 22px;
            font-weight: 700;
        }

        .box-lens-details .box-header .btn {
        ...
        .box-lens-details .box-header .btn:hover {
            background: white;
            color: #667eea;
        }
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-eyeglasses"></i> Lens Details
            <small>{{ $lens->product_id }}</small>
        </h1>
    </section>

    <div class="lens-show-page">
        <!-- Header -->
        <div class="box box-primary box-lens-details">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-info-circle-fill"></i> {{ $lens->product_id }} - {{ $lens->description }}
                </h3>
                <div class="box-tools pull-right">
                    <a href="{{ route('dashboard.get-edit-glense', $lens->id) }}" class="btn btn-sm">
                        <i class="bi bi-pencil-square"></i> Edit Lens
                    </a>
                    <a href="{{ route('dashboard.get-glassess-lenses') }}" class="btn btn-sm" style="margin-left: 10px;">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                <div class="info-item">
                    ...
                    <span class="value">{{ $lens->product_id }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Description:</span>
                    <span class="value">{{ $lens->description ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Brand:</span>
                    <span class="value">{{ $lens->brand ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                <div class="info-item">
                    <span class="label">Frame Type:</span>
                    <span class="value">{{ $lens->frame_type ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Lens Type:</span>
                    <span class="value">{{ $lens->lense_type ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Life Style:</span>
                    <span class="value">{{ $lens->life_style ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Customer Activity:</span>
                    <span class="value">{{ $lens->customer_activity ?? 'N/A' }}</span>
                </div>
            </div>

            <div class="info-row">
                <div class="info-item">
                    <span class="label">Lens Technology:</span>
                    <span class="value">{{ $lens->lense_tech ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="label">Production Type:</span>
                    <span class="value">{{ $lens->lense_production ?? 'N/A' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                <div class="info-item">
                    ...
                    <span class="value">{{ number_format($lens->price, 2) }} SAR</span>
                </div>
                <div class="info-item">
                    <span class="label">Retail Price:</span>
                    <span class="value">{{ number_format($lens->retail_price, 2) }} SAR</span>
                </div>
                <div class="info-item">
                    <span class="label">Profit Margin:</span>
                    <span class="value">{{ number_format($lens->retail_price - $lens->price, 2) }} SAR</span>
                </div>
                <div class="info-item">
                    <span class="label">Profit %:</span>
                    <span class="value">
                        {{ $lens->retail_price > 0 ? number_format((($lens->retail_price - $lens->price) / $lens->retail_price) * 100, 2) : '0' }}%
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            @else
                <div class="alert alert-info">
                    ...
                    No stock records found for this lens in branches.
                </div>
            @endif
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-item">
                    <span class="label">Total Sales Value:</span>
                    <span class="value">{{ number_format($totalSold * $lens->retail_price, 2) }} SAR</span>
                </div>
            </div>
        </div>
    </div>
