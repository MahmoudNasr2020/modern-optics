...
@section('content')
    ...
    <section class="content-header">
        <h1><i class="bi bi-pencil-square"></i> Edit Lens Brand</h1>
    </section>
    ...
    <div style="padding:20px;">
        ...
        <form action="{{ route('dashboard.lens-brands.update', $lensBrand) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="page-card">
                ...
                <div class="sec-header">
                    <div class="sec-header-left">
                        <i class="bi bi-building"></i> Edit Brand — <span style="opacity:.85;font-weight:500;">{{ $lensBrand->name }}</span>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="brandName" class="form-control"
                                   value="{{ old('name', $lensBrand->name) }}"
                                   placeholder="e.g. Essilor, Hoya, Zeiss..." required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <input type="checkbox" name="is_active" id="isActive" value="1"
                                   {{ old('is_active', $lensBrand->is_active) ? 'checked' : '' }}
                                   style="display:none!important;">
                            <div class="status-ui" id="statusUI">
                                <div class="status-box {{ old('is_active', $lensBrand->is_active) ? 'on' : '' }}" id="statusBox">
                                ...
                                <span class="check-badge {{ old('is_active', $lensBrand->is_active) ? 'on' : 'off' }}" id="activeBadge">
                                    {{ old('is_active', $lensBrand->is_active) ? 'Active' : 'Inactive' }}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="2"
                              placeholder="Short description about this brand...">{{ old('description', $lensBrand->description) }}</textarea>
                </div>
                ...
                <div class="form-group" style="margin-top:8px;">
                    ...
                    <div class="logo-upload-wrap" id="uploadZone">
                        <div class="logo-img-box" id="logoBox">
                            @if($lensBrand->logo)
                                <img src="{{ Storage::url($lensBrand->logo) }}" alt="{{ $lensBrand->name }}" id="logoPreview">
                            @else
                        ...
                        <div class="logo-upload-info">
                            ...
                            <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                                ...
                                <button type="button" class="btn-remove-logo {{ $lensBrand->logo ? 'visible' : '' }}" id="removeLogoBtn">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            var originalName = '{{ $lensBrand->name }}';
            var timer;
            ...
            $('#brandName').on('input', function () {
                ...
                if (name.toLowerCase() === originalName.toLowerCase()) {
                    $('#nameCheck').text('✓ Current brand name.').removeClass('err').addClass('ok');
                    $('#saveBtn').prop('disabled', false); return;
                }
            ...
            /* ── Checkbox (iCheck-safe) ── */
            var isChecked = $('#isActive').prop('checked');
