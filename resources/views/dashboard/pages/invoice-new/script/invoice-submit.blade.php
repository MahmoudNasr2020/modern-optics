<script>
    ...
    function updatePayerFromPayments() {
        ...
        $('[data-summary-field="payer"]').text(display);
    ...
    function setupPaymentEvents() {
        ...
        // Remove payment — also update payer total
        $('.remove-payment-btn').off('click').on('click', function() {
            $(this).closest('.payment-row').remove();
            updatePayerFromPayments();
        });

        // Amount changed — update payer total live
        $('.payment-amount').off('input change').on('input change', function() {
            updatePayerFromPayments();
        });
    }
