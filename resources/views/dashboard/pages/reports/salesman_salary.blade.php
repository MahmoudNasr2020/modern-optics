...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-wallet2"></i> Salesman Salary
            <small>Commission & salary report</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Reports</a></li>
            <li class="active">Salesman Salary</li>
        </ol>
    </section>
    ...
    <div class="report-page">
        <div class="box box-primary box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-cash-coin"></i> Salesman Salary Report
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-salesman-salary') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report shows salesman salary breakdown including base salary, sales commission, and total compensation for the selected period. Click "Print" to generate the detailed report.</p>
                </div>
            </div>
        </div>
    </div>
