    ...
    @if(isset($invoices) && $invoices->count() > 0)
        ...
        <table class="report-table">
            ...
            <tr>
                ...
                <th style="width: 110px; text-align: right;">BEFORE DISC.</th>
                <th style="width: 90px; text-align: right;">DISCOUNT</th>
                <th style="width: 110px; text-align: right;">NET TOTAL</th>
...
@include('dashboard.partials._report_export_toolbar', ['filename' => 'pending-invoices-report'])
</body>
</html>
