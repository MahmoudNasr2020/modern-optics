...
<head>
    ...
    <title>Return Invoices Report</title>
...
<div class="report-container">
    ...
    <div class="report-header">
        ...
        <div class="report-title">
            ...
            <div class="subtitle">Returned/Canceled Invoices Report</div>
            <div class="date-info">
    ...
    @if(isset($invoices) && $invoices->count() > 0)
        ...
        <div class="stats-row">
            ...
            <div class="stat-box">
                {{-- ✅ summaryBeforeDiscount جاي من الكنترولر --}}
                <div class="number">{{ number_format($summaryBeforeDiscount, 2) }}</div>
                <div class="label">Before Discount</div>
            </div>
            <div class="stat-box">
                {{-- ✅ summaryDiscount = summaryBeforeDiscount - summaryNet --}}
                <div class="number">{{ number_format($summaryDiscount, 2) }}</div>
                <div class="label">Total Discount</div>
            </div>
            <div class="stat-box">
                {{-- ✅ summaryNet = sum(total) --}}
                <div class="number">{{ number_format($summaryNet, 2) }}</div>
                <div class="label">Net Total</div>
            </div>
            <div class="stat-box">
                <div class="number">{{ number_format($summaryPaid, 2) }}</div>
                <div class="label">Total Paid</div>
            </div>
            <div class="stat-box">
                <div class="number">{{ number_format($summaryBalance, 2) }}</div>
        ...
        <table class="report-table">
            ...
            <tr>
                ...
                <th style="width: 80px;">PICK-UP</th>
                ...
                <th style="width: 120px;">CANCELED AT</th>
            ...
            @foreach($invoices as $item)
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <strong>
                            {{ $item->canceled_at ? \Carbon\Carbon::parse($item->canceled_at)->format('d/m/Y') : '' }}
                        </strong>
                    </td>
                    <td>
                        @if($item->return_reason)
                            <span class="reason-badge" title="{{ $item->return_reason }}">{{ $item->return_reason }}</span>
                        @else
    ...
    @else
        ...
        <div class="empty-state">
            ...
            <h3>No Return Invoices</h3>
            <p>There are no returned or canceled invoices for the selected date range.</p>
        </div>
    @endif
    ...
    <div class="report-footer">
        <p>
            <strong>Optics Modern</strong> - Return Invoices Report<br>
            This is a system-generated report showing all returned/canceled invoices.<br>
            Report generated on {{ date('Y-m-d H:i:s') }}
        </p>
    </div>
</div>

@include('dashboard.partials._report_export_toolbar', ['filename' => 'return-invoices-report'])
</body>
</html>
