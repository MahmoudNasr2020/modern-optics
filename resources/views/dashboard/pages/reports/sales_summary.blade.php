...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Products sales analysis</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="report-page">
        <div class="box box-primary box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-graph-up-arrow"></i> Sales Summary Report
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-sales-summary') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report provides a comprehensive analysis of product sales grouped by category, including quantity sold, cost prices, retail prices, and profit calculations for the selected period.</p>
                </div>
            </div>
        </div>
    </div>
