...
<head>
    ...
    <title>Items Delivered Report</title>
...
<div class="report-container">
    ...
    <div class="report-header">
        ...
        <div class="report-title">
            ...
            <div class="subtitle">Completed Delivery Report</div>
            <div class="date-info">
    ...
    @else
        ...
        <div class="empty-state">
            ...
            <p>There are no delivered items for the selected date range.</p>
        </div>
    @endif
    ...
    <div class="report-footer">
        <p>
            <strong>Optics Modern</strong> - Items Delivered Report<br>
            This is a system-generated report showing all items with status "Delivered".<br>
            Report generated on {{ date('Y-m-d H:i:s') }}
        </p>
    </div>
</div>

@include('dashboard.partials._report_export_toolbar', ['filename' => 'items-delivered-action-report'])
</body>
</html>
