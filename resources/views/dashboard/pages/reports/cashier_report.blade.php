...
@section('content')
    ...
    <style>
        ...
        .filter-section label i { color: #2980b9; margin-right: 5px; }
        ...
        .alert-info-custom i {
            color: #2980b9; font-size: 24px;
            margin-right: 15px; flex-shrink: 0;
        }

        .alert-info-custom strong { color: #1a5276; font-size: 16px; }
        .alert-info-custom p { margin: 5px 0 0; color: #1a5276; font-size: 14px; }
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-cash-coin"></i> Cashier Report
            <small>Sales &amp; Returns by Payment Method</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Reports</a></li>
            <li class="active">Cashier Report</li>
        </ol>
    </section>
    ...
    <div class="report-page">
        <div class="box box-primary box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-cash-coin"></i> Cashier Report — Sales &amp; Returns
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="row info-cards">
                    ...
                    <div class="col-md-{{ auth()->user()->canSeeAllBranches() ? '3' : '4' }}">
                        <div class="info-card">
                            ...
                            <h3>Invoice Per Row</h3>
                            <p>One row &amp; column per payment</p>
                        </div>
                    </div>
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-cashier') }}" method="GET" target="_blank">
                        <div class="row">
                ...
                <div class="alert-info-custom">
                    ...
                    <div>
                        ...
                        <p>
                            This report shows all cashier transactions (Sales &amp; Returns) in the selected date range.
                            Each invoice appears as <strong>one row</strong>. Payment methods (CASH, VISA, ATM...) appear as
                            <strong>separate columns</strong>. Returns are shown in separate rows highlighted in red.
                            Click "Print" to open the report in a new window.
                        </p>
                    </div>
                </div>
