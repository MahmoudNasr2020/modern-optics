...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-check-circle"></i> Items Delivered
            <small>Completed delivery report</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Reports</a></li>
            <li class="active">Items Delivered</li>
        </ol>
    </section>
    ...
    <div class="report-page">
        <div class="box box-success box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-check-circle"></i> Successfully Delivered Items
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="row info-cards">
                    ...
                    <div class="col-md-{{ auth()->user()->canSeeAllBranches() ? '3' : '4' }}">
                        <div class="info-card">
                            ...
                            <p>Items successfully delivered</p>
                        </div>
                    </div>
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-items-delivered') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report shows all items with status "Delivered" within the selected date range. Click "Print" to generate the report in a new window.</p>
                </div>
            </div>
        </div>
    </div>
