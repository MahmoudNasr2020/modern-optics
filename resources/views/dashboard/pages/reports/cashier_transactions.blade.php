...
@section('title', 'Cashier Transactions')
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="bi bi-wallet2"></i> Cashier Transactions
            <small>Payment transactions report</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Reports</a></li>
            <li class="active">Cashier Transactions</li>
        </ol>
    </section>
    ...
    <div class="report-page">
        <div class="box box-info box-report">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i class="bi bi-wallet2"></i> Payment Transactions Report
                </h3>
            </div>
            ...
            <div class="box-body" style="padding: 30px;">
                ...
                <div class="filter-section">
                    <form action="{{ route('dashboard.report-cashier-transactions') }}" method="GET" target="_blank">
                        <div class="row">
                            @if(auth()->user()->canSeeAllBranches())
                                <div class="col-md-3">
                ...
                <div class="alert-info-custom">
                    ...
                    <p>This report shows all cashier transactions including sales, refunds, and expenses grouped by payment method. It provides a comprehensive summary of all payment activities within the selected date range.</p>
                </div>
            </div>
        </div>
    </div>
